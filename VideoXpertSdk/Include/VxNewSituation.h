...
namespace VxSdk {
    ...
    public:
        ...
        VxNewSituation(const VxNewSituation& ref) {
            ...
            this->shouldPopupBanner = ref.shouldPopupBanner;
            ...
            if (ref.snoozeIntervals != nullptr) {
                this->snoozeIntervals = new int[ref.snoozeIntervalSize];
                for (int i = 0; i < ref.snoozeIntervalSize; i++)
                    this->snoozeIntervals[i] = ref.snoozeIntervals[i];
            }
        }
