...
namespace VxSdk {
    ...
    public:
        ...
        /// <summary>
        /// Gets the <see cref="IVxDataInterface"/> used by this session.
        /// </summary>
        /// <param name="dataInterface">The <see cref="IVxDataInterface"/> used by this session.</param>
        /// <returns>The <see cref="VxResult::Value">Result</see> of the request.</returns>
        virtual VxResult::Value GetDataInterface(IVxDataInterface*& dataInterface) const = 0;
        /// <summary>
        ...
        /// </summary>
        /// <returns>The <see cref="VxResult::Value">Result</see> of the request.</returns>
        virtual VxResult::Value RefreshSession() = 0;
        /// <summary>
        ...
        /// </summary>
        /// <returns>The <see cref="VxResult::Value">Result</see> of updating this objects member values.</returns>
