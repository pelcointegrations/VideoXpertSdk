...
namespace VxSdk {
    ...
    public:
        ...
        VxNewSchedule(const VxNewSchedule& ref) {
            ...
            if (ref.scheduleTriggers != nullptr) {
                this->scheduleTriggers = new VxNewScheduleTrigger[ref.scheduleTriggerSize];
                for(int i = 0; i < ref.scheduleTriggerSize; i++)
                    this->scheduleTriggers[i] = VxNewScheduleTrigger(ref.scheduleTriggers[i]);
            }
        }
    ...
    public:
        ...
        /// <summary>
        /// The <see cref="VxNewScheduleTrigger">VxNewScheduleTriggers</see> to create for the new schedule. Maximum of
